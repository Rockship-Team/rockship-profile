...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({
  ...
  const CardContent = (
    <div className="group relative h-full w-full flex flex-col bg-rockship-900/60 backdrop-blur-md border border-white/8 shadow-[0_8px_32px_0_rgba(0,0,0,0.2)] rounded-2xl p-1 transition-all duration-300 hover:border-white/20 hover:shadow-2xl hover:shadow-rockship-accent/10">
