...
export function TimelineNodeView({
  ...
  const { items } = node.attrs as { items: TimelineItem[] }
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <h4 className="font-semibold text-white mt-1 group-hover:text-rockship-accent transition-colors duration-300">
                      {item.title}
                    </h4>
